...
def trigger_random_event(battle: Dict) -> Dict:
    ...
    events = [
        {"name": "mirror", "chance": 0.1, "description": "🪞 Магическое зеркало активировано: магическая сила были инвертирована!"},
        {"name": "fog_full", "chance": 0.05, "description": "Магическая сила и прогресс скрыты!"},
        {"name": "fog_partial", "chance": 0.05, "description": "Магическая сила скрыта, но прогресс виден!"},
