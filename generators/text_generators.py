...
class UndressGenerator:
    def __init__(self):
        ...
        self.persona_reactions = {
            ...
            'дерзкая': [
                ...
                "<b>{Name}</b> проводит руками по своему телу, подчёркивая каждый изгиб.",
                "{She} закидывает голову назад и смеётся, демонстрируя тонкую шейку.",
            ...
            'кокетливая': [
                ...
                "{She} проводит руками по своему телу, подчёркивая каждый изгиб.",
        ...
        self.body_parts = {
            'трусики': [
                ...
                "нежную складочку",
                "розовый бутон",
                "блестящие от возбуждения половые губы",
                "набухшие половые губки",
                "дрожащую от желания 'киску'",
                "трепещущий бутон",
            ],
            'лифчик': [
                "грудь",
                ...
                "пышные формы",
                "набухшие сосочки",
                "твёрдые как ягоды соски",
                "розовые ареолы",
                "дрожащие груди",
                "чувствительные холмики",
                "покрытые капельками влаги соски",
                "напряжённые от возбуждения груди",
                "нежную кожу декольте",
                "соблазнительную ложбинку между грудей",
                "покрытые мурашками груди",
                "пышно поднимающиеся формы",
                "дрожащие от страсти груди",
                "налитые соком груди",
            ],
            'чулки': [
                "ножки",
                ...
                "дрожащие колени",
                "дрожащие от возбуждения ноги",
                "покрытые мурашками бёдра",
            ...
            'платье': [
                ...
                "изгибы",
                "гибкую талию",
                "соблазнительные изгибы спины",
                "нежную шейку",
                "дрожащие плечи",
                "соблазнительную ложбинку на спине",
                "трепещущий живот",
                "дрожащие бёдра",
                "соблазнительный изгиб ягодиц",
            ],
            'плащ': [
                "платье",
                "талию",
    ...
    def generate_player_undress(self, mob_data: Dict) -> str:
        ...
        sentence1 = random.choice(
            phrases[:8]
        )  # Первое предложение всегда с именем/титулом
    ...
    def generate(self, mob_data: Dict, mob_outfit_left) -> str:
        ...
        undress_text = random.choice(self.undressing_process[clothing_type]).format(
            clothing=clothing_nom, Clothing=clothing_nom.capitalize()
        )
        # 3. Реакция персонажа
        ...
        full_text = (
            f"{spell_text}{connector}{undress_text}. {reaction_text} {final_phrase}"
        )
